    ...
    <>
      ...
      <main className="bg-white pt-32 pb-20">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-12">
          <a href="/news" className="inline-flex items-center text-xs font-semibold tracking-widest text-gray-500 uppercase hover:text-gray-900 transition-colors">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-12 max-w-4xl mx-0">
          ...
          <div className="flex items-center space-x-6 border-b border-gray-200 pb-8">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gray-900 text-white flex items-center justify-center text-sm font-bold">
                PE
              </div>
              <div className="flex flex-col">
                <span className="text-sm font-semibold tracking-widest text-gray-900 uppercase">Prime Expertise Team</span>
                <span className="text-xs text-gray-500 font-light mt-1">{post.date}</span>
              </div>
            </div>
            <div className="h-8 w-[1px] bg-gray-200"></div>
            <span className="text-sm text-gray-500 font-light tracking-widest uppercase">{post.readTime}</span>
          </div>
        </section>
        ...
        <section className="bg-gray-50 py-24 border-y border-gray-100">
          <div className="container mx-auto px-6 md:px-12 lg:px-24">
            ...
            <div className="text-center mt-12">
              <a href="/news" className="inline-flex items-center text-sm font-semibold tracking-widest text-gray-900 uppercase hover:text-gray-500 transition-colors">
                <ArrowLeft className="mr-3 w-4 h-4" />
                All News & Resources
              </a>
            </div>
