      ...
      <main className="bg-white pt-32 pb-20">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-200">
            ...
            <div className="p-10 md:p-16 border-b md:border-b-0 md:border-r border-gray-200 bg-white hover:bg-gray-50 transition-colors duration-500">
              <h3 className="text-sm font-semibold tracking-widest text-primary uppercase mb-6 flex items-center">
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
              ...
              <div className="relative">
                ...
                <h4 className="text-xl font-medium text-primary mb-4">Integrity</h4>
              ...
              <div className="relative">
                ...
                <h4 className="text-xl font-medium text-primary mb-4">Excellence</h4>
              ...
              <div className="relative">
                ...
                <h4 className="text-xl font-medium text-primary mb-4">Collaboration</h4>
              ...
              <div className="relative">
                ...
                <h4 className="text-xl font-medium text-primary mb-4">Innovation</h4>
              ...
              <div className="relative">
                ...
                <h4 className="text-xl font-medium text-primary mb-4">Inclusivity</h4>
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a href="/#services" className="border border-gray-900 bg-primary text-white px-8 py-4 text-sm font-semibold tracking-widest uppercase hover:bg-white hover:text-primary transition-colors duration-300">
              Our Services
            </a>
