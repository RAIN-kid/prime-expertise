        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 border border-gray-200">
            ...
            <div className="lg:col-span-7 bg-white p-8 md:p-16 border-b lg:border-b-0 lg:border-r border-gray-200">
              <form className="space-y-10">
                ...
                <div className="flex flex-col">
                  ...
                  <select defaultValue="" className="border-0 border-b border-gray-300 py-3 px-0 bg-transparent focus:ring-0 focus:border-gray-900 rounded-none transition-colors w-full outline-none text-gray-900 font-light appearance-none cursor-pointer">
                ...
                <div className="pt-4 flex flex-col space-y-8">
                  <label className="flex items-start space-x-4 cursor-pointer group">
                    ...
                    <span className="text-sm text-gray-600 font-light group-hover:text-gray-900 transition-colors leading-relaxed">
                      ...
                      By checking the box, you acknowledge that you have read, understood, and agree to abide by Prime Expertise's <a href="#privacy" className="underline font-medium">Data Protection and Privacy Policy</a>.
                    </span>
                  </label>
            ...
            <div className="lg:col-span-5 bg-gray-50 p-8 md:p-16 flex flex-col justify-center">
              <h3 className="text-2xl font-light text-gray-900 mb-10 pb-4 border-b border-gray-200">
                Contact details
              </h3>
