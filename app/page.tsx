...
import Navbar from "./components/Navbar"; // Tuna-import Navbar yetu hapa
    ...
    <>
      ...
      <main className="relative min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://primexpert.vercel.app/images/14-scaled.jpg"
            alt="Data Collection in Tanzania"
        ...
        {/* Content ya Kiofisi */}
        <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-24 flex flex-col items-start mt-16">
          
          {/* Kistari cha Kifahari */}
          <motion.div
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-light text-white leading-tight tracking-tight mb-6">
              ...
              <span className="font-medium">Services in Tanzania</span>
            </h1>
          </motion.div>
          ...
          >
            <a
              href="#services"
              className="group flex items-center justify-center border border-white/50 px-8 py-4 text-white hover:bg-white hover:text-black transition-all duration-300 cursor-pointer"
            >
      ...
      <section className="py-24 bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          ...
          {/* Grid ya Logo - Imepangwa kwa mistari miwili inayo-balance */}
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-8 gap-y-10 items-center justify-items-center opacity-80">
            
            <img 
              src="https://primexpert.vercel.app/client/mecslogo.png" 
              alt="UKAid MECS" 
              className="h-12 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/15_karl-kuebel-stiftung.png" 
              alt="Karl Kübel Stiftung" 
              className="h-12 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/thefred.png" 
              alt="The Fred Hollows Foundation" 
              className="h-12 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/hystra.png" 
              alt="Hystra" 
              className="h-10 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/loughborough-univeristy-lboro-logo-1024x258.png" 
              alt="Loughborough University" 
              className="h-10 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/CSSC-logo-bgless.png" 
              alt="CSSC" 
              className="h-14 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/CcNLE7oh_400x400.jpg" 
              alt="Partner" 
              className="h-12 rounded-full object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/afrifoodlinks-logo-mobile-full.c76c76-1024x434.png" 
              alt="AfriFOODlinks" 
              className="h-10 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/iclei.png" 
              alt="ICLEI" 
              className="h-12 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/rikolto.png" 
              alt="Rikolto" 
              className="h-10 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/GDC%20Consulting.png" 
              alt="GDC Consulting" 
              className="h-12 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
            <img 
              src="https://primexpert.vercel.app/client/Logo.png" 
              alt="Client Logo" 
              className="h-10 object-contain grayscale hover:grayscale-0 transition-all duration-500 cursor-pointer"
            />
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-gray-200 mb-16">
            ...
            <div className="p-8 md:p-16 flex flex-col justify-center bg-white border-b lg:border-b-0 lg:border-r border-gray-200">
              <h4 className="text-2xl font-light text-gray-900 mb-6 border-b border-gray-100 pb-4 inline-block w-fit">
                Our Offices
              </h4>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-16 border-b border-gray-200 pb-8">
            ...
            <div className="mt-8 md:mt-0">
              <a href="/work" className="group flex items-center text-sm font-semibold uppercase tracking-widest text-gray-900 hover:text-gray-500 transition-colors duration-300">
              ...
              >
                ...
                <div className="w-full h-48 overflow-hidden relative bg-gray-100 border-b border-gray-100">
                  <img 
                    ...
                    src={
                      study.id === 1 ? "https://primexpert.vercel.app/_next/image?url=https%3A%2F%2Fimages.unsplash.com%2Fphoto-1559839734-2b71ea197ec2%3Fw%3D800%26h%3D500%26fit%3Dcrop&w=640&q=75" :
