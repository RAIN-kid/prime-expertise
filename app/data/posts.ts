...
export const allPosts = [
  // 1. ILE POST KUBWA YA JUU (Hero)
  {
    id: 1,
    slug: "unlocking-development-impact",
  ...
  // ZILE 5 ZA PEMBENI (Other Featured Posts)
  {
    id: 2,
    slug: "revolutionizing-me-systems",
  ...
  {
    id: 3,
    slug: "synergizing-research-data",
    title: "Synergizing research and data for development outcomes",
    shortDesc: "Combining qualitative and quantitative research with robust data systems to drive measurable impact.",
    fullContent: "Combining qualitative and quantitative research with robust data systems to drive measurable impact.",
    image: "post3.webp",
    category: "Research",
    date: "January 2026",
    readTime: "6 min read"
  ...
  {
    id: 4,
    slug: "navigating-initiatives-robust-frameworks",
  ...
  {
    id: 5,
    slug: "sculpting-impact-evidence-design",
  ...
  {
    id: 6,
    slug: "transforming-platforms-odyssey",
  ...
  // ZILE 4 ZA CHINI (Recent Posts Grid)
  {
    id: 7,
    slug: "mastering-me-frameworks-practical-guide",
  ...
  {
    id: 8,
    slug: "crafting-seamless-data-collection",
    title: "Crafting Seamless Data Collection: The Art of Intuitive Survey Design",
    shortDesc: "Best practices for developing data collection tools that yield high-quality, actionable insights for your development initiatives.",
    fullContent: "Best practices for developing data collection tools that yield high-quality, actionable insights for your development initiatives.",
    image: "post8.webp",
  ...
  {
    id: 9,
    slug: "beyond-numbers-qualitative-research",
  ...
  {
    id: 10,
    slug: "collaborative-programme-mecs-tanzania",
    title: "Beyond Numbers: The Power of Qualitative Research in Development",
    shortDesc: "Explore how in-depth qualitative methods complement quantitative data to tell the full story of program impact.",
    fullContent: "Explore how in-depth qualitative methods complement quantitative data to tell the full story of program impact.",
    image: "post11.jpg",
