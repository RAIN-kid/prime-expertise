  ...
  return (
    <section className="relative py-32 bg-gray-900 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10 flex flex-col items-center text-center">
        ...
        <a
          href="#register"
          className="group flex items-center justify-center border border-primary px-10 py-4 text-primary hover:bg-white hover:text-gray-900 transition-all duration-300 cursor-pointer"
        >
