    ...
    <>
      ...
      <main className="bg-white pt-32 pb-20">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-12">
          <a href="/opportunities" className="inline-flex items-center text-xs font-semibold tracking-widest text-primary uppercase hover:text-gray-900 transition-colors">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-16 max-w-4xl mx-0">
          ...
          <p className="text-sm font-medium tracking-widest text-primary uppercase flex flex-wrap gap-4 items-center">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-10 text-center">
          <div className="bg-white border-t border-gray-200 pt-20">
            ...
            <a 
              ...
              className="inline-flex bg-primary text-white px-10 py-4 text-sm font-semibold tracking-widest uppercase hover:bg-gray-800 transition-colors duration-300 items-center justify-center"
            >
