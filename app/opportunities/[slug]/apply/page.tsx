    ...
    <>
      ...
      <main className="bg-white pt-32 pb-20">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-12">
          <a href={`/opportunities/${job.slug}`} className="inline-flex items-center text-xs font-semibold tracking-widest text-primary uppercase hover:text-gray-900 transition-colors">
