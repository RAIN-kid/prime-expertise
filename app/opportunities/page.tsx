  ...
  return (
    <>
      ...
      <main className="bg-white pt-32 pb-20">
        ...
        {/* INTRODUCTION & REGISTRATION FORM (Code ileile ya fomu inabaki hapa...) */}
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-7 bg-white border border-gray-200 p-8 md:p-12 shadow-sm h-fit sticky top-32">
              <h3 className="text-2xl font-light text-primary/80 mb-8 pb-4 border-b border-gray-100">Register Your CV</h3>
              <form className="space-y-8">
                ...
                <div className="flex flex-col pt-4">
                  ...
                  <p className="text-xs text-gray-400 mt-3 font-light">Here is our recommended, commonly used <a href="#template" className="text-gray-900 hover:underline font-medium text-primary/80">CV template</a>.</p>
                </div>
                <div className="pt-8 border-t border-gray-100 flex flex-col space-y-6">
                  <label className="flex items-center space-x-3 cursor-pointer group">
                    ...
                    <span className="text-sm text-gray-600 font-light group-hover:text-gray-900 transition-colors">I Agree to the <a href="#terms" className="underline font-medium text-primary/80">Terms and Conditions</a> and Data Protection Policy.</span>
                  </label>
        ...
        <section className="bg-gray-50 py-24 border-y border-gray-100">
          <div className="container mx-auto px-6 md:px-12 lg:px-24">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-16 border-b border-gray-200 pb-6">
              <div>
                <h3 className="text-3xl font-light text-gray-900 mb-2">Vacancies</h3>
                <p className="text-gray-500 font-light">Current open positions and tenders. Showing {opportunities.length} results.</p>
              </div>
              <div className="mt-4 md:mt-0 flex items-center text-sm font-light text-primary">
                <span className="mr-2">Sort by:</span>
                <select defaultValue="Relevance" className="bg-transparent border-0 border-b border-gray-300 focus:ring-0 focus:border-gray-900 text-gray-900 font-medium outline-none cursor-pointer pb-1">
            ...
            {/* Grid ya Kadi za Kazi Zinazosomwa kutoka kwenye DB */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {opportunities.map((job) => (
                <a key={job.id} href={`/opportunities/${job.slug}`} className="group bg-white border border-gray-200 flex flex-col hover:border-gray-400 transition-colors duration-500 cursor-pointer">
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    <h4 className="text-lg font-medium text-primary mb-4 leading-snug group-hover:text-gray-600 transition-colors line-clamp-2">
                      {job.title}
                    </h4>
                    ...
                    <div className="mt-auto pt-6 border-t border-gray-100 flex items-center text-xs font-semibold uppercase tracking-widest text-gray-900">
                      Read More 
                      <ArrowRight className="ml-2 w-3 h-3 group-hover:translate-x-2 transition-transform duration-300" />
                    </div>
                  </div>
                </a>
              ))}
