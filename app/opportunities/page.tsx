        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-7 bg-white border border-gray-200 p-8 md:p-12 shadow-sm h-fit sticky top-32">
              <h3 className="text-2xl font-light text-gray-900 mb-8 pb-4 border-b border-gray-100">Register Your CV</h3>
              <form className="space-y-8">
                ...
                <div className="flex flex-col pt-4">
                  ...
                  <p className="text-xs text-gray-400 mt-3 font-light">Here is our recommended, commonly used <a href="#template" className="text-gray-900 hover:underline font-medium">CV template</a>.</p>
                </div>
                <div className="pt-8 border-t border-gray-100 flex flex-col space-y-6">
                  <label className="flex items-center space-x-3 cursor-pointer group">
                    ...
                    <span className="text-sm text-gray-600 font-light group-hover:text-gray-900 transition-colors">I Agree to the <a href="#terms" className="underline font-medium">Terms and Conditions</a> and Data Protection Policy.</span>
                  </label>
        ...
        <section className="bg-gray-50 py-24 border-y border-gray-100">
          <div className="container mx-auto px-6 md:px-12 lg:px-24">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-16 border-b border-gray-200 pb-6">
              ...
              <div className="mt-4 md:mt-0 flex items-center text-sm font-light text-gray-500">
              ...
              {opportunities.map((job) => (
                <a key={job.id} href={`/opportunities/${job.slug}`} className="group bg-white border border-gray-200 flex flex-col hover:border-gray-400 transition-colors duration-500 cursor-pointer">
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    <h4 className="text-lg font-medium text-gray-900 mb-4 leading-snug group-hover:text-gray-600 transition-colors line-clamp-2">
                      {job.title}
                    </h4>
