        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-32 space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-gray-200 group hover:border-gray-400 transition-colors duration-500">
            ...
            <div className="p-10 md:p-16 flex flex-col justify-center bg-white">
              <span className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-4 block">01</span>
              <h3 className="text-3xl font-light text-gray-900 mb-6">Research</h3>
              <div className="h-[1px] w-16 bg-gray-200 mb-6"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-gray-200 group hover:border-gray-400 transition-colors duration-500 flex-col-reverse lg:flex-row">
            ...
            <div className="p-10 md:p-16 flex flex-col justify-center bg-white border-b lg:border-b-0 lg:border-r border-gray-200 order-2 lg:order-1">
              <span className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-4 block">02</span>
              <h3 className="text-3xl font-light text-gray-900 mb-6">Data Handling & Management</h3>
              <div className="h-[1px] w-16 bg-gray-200 mb-6"></div>
              <p className="text-gray-600 font-light text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-gray-200 group hover:border-gray-400 transition-colors duration-500">
            ...
            {/* Maelezo Kulia */}
            <div className="p-10 md:p-16 flex flex-col justify-center bg-white">
              <span className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-4 block">03</span>
              <h3 className="text-3xl font-light text-gray-900 mb-6">Monitoring & Evaluation</h3>
              <div className="h-[1px] w-16 bg-gray-200 mb-6"></div>
              <p className="text-gray-600 font-light text-lg leading-relaxed">
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-24 mb-10 text-center">
          <div className="bg-gray-50 border border-gray-200 py-20 px-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <a href="/news" className="border border-gray-900 bg-gray-900 text-white px-8 py-4 text-sm font-semibold tracking-widest uppercase hover:bg-white hover:text-gray-900 transition-colors duration-300">
                View our work
              </a>
